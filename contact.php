<?php 
	...
	#Your e-mail address
	define("__TO__", "tsadbarranquilla@gmail.com");

	#Message subject
	define("__SUBJECT__", "Mensaje de: ");

	#Success message
	define('__SUCCESS_MESSAGE__', "Su mensaje ha sido enviado. Gracias!");

	#Error message 
	define('__ERROR_MESSAGE__', "Error, su mensaje no ha sido enviado");

	#Messege when one or more fields are empty
	define('__MESSAGE_EMPTY_FILDS__', "Por favor completar los campos que faltan");
